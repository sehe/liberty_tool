...
struct liberty_grammar : qi::grammar<iterator, ast::container(), skipper_grammar<iterator>> {
    liberty_grammar() : liberty_grammar::base_type(lib_file) {
        ...
        qi::on_error<qi::fail>(lib_file, boost::phoenix::bind(on_error, qi::_1, qi::_2, qi::_3, qi::_4));
    }
